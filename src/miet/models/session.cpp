...
{
    void SessionTokensData::SerializeToJson(userver::formats::json::ValueBuilder& json) const
    {
        utils::JsonProcessor::Write(json, "session_token", session_token);
        utils::JsonProcessor::Write(json, "refresh_token", refresh_token);
    }

    void SessionTokensData::DeserializeFromJson(const userver::formats::json::Value& json)
    {
        utils::JsonProcessor::Read(json, "session_token", session_token);
        utils::JsonProcessor::Read(json, "refresh_token", refresh_token);
    }

    void UserSessionData::SerializeToJson(userver::formats::json::ValueBuilder& json) const
    {
    ...
    void UserSessionData::DeserializeFromJson(const userver::formats::json::Value& json)
    {
    ...
    {
        SessionTokensData::SerializeToJson(json);
        UserSessionData::SerializeToJson(json);
    ...
    {
        SessionTokensData::DeserializeFromJson(json);
        UserSessionData::DeserializeFromJson(json);
